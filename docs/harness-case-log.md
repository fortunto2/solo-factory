...
## Moved out of `rules/harness-sensors.md` on 2026-09-12

Both sections below were the rules file's two largest, 808 lines and 67% of it,
and both are case material rather than contract. `memory_map.py` put the always-loaded
payload at 293% of budget with this one file as 62% of it. The promises they support
stayed in the rules; the evidence lives here.
